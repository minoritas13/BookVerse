    ...
    <nav class="container flex items-center justify-between px-4 py-3 mx-auto">
        ...
        @auth
            <ul class="hidden space-x-6 font-medium text-gray-700 md:flex">
                <li><a href="{{ route('admin.dashboard') }}" class="transition hover:text-blue-600">Dashboard</a></li>
                <li><a href="{{ route('admin.books') }}" class="transition hover:text-blue-600">Books</a></li>
                <li>
